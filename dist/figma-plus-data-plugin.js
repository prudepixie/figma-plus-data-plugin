(function (global, factory) {
  ...
  unwrapExports(dist);
  var dist_1 = dist.TransformType;
  var dist_2 = dist.textTransform;

  var getContentTypeData =
  /*#__PURE__*/
  function () {
    var _ref = asyncToGenerator(
    /*#__PURE__*/
    regenerator.mark(function _callee(id, num) {
      var arr, dataType, url, data;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              url = "https://randomuser.me/api/?inc=".concat(dataType, "&results=").concat(num);
              _context.next = 7;
              return getData(url);
    ...
    return function getContentTypeData(_x, _x2) {
  ...
  var DataGeneratorPlugin = function DataGeneratorPlugin() {
    ...
    defineProperty(this, "attachEvents", function () {
      ["#names"].map(function (id) {
        return getDomNode(id).addEventListener("input", _this.toggleOptionsPanel);
      });
      ["#usernames", "#email", "#countries", "#addresses"].map(function (id) {
        return getDomNode(id).addEventListener("click", function () {
          return _this.getContentTypeList(id);
        });
    ...
    defineProperty(this, "showUI", function () {
      ...
      window.figmaPlus.showUI(_this.pluginName, function (modalElement) {
        ...
        _this.attachEvents();
      }, 300, 300, 0.5, 0.5, false, false);
    });

    defineProperty(this, "toggleOptionsPanel", function () {});

    defineProperty(this, "getContentTypeList",
    /*#__PURE__*/
    function () {
      var _ref = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee2(id) {
        var selectedNodes;
        return regenerator.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                selectedNodes = Object.keys(window.App._state.mirror.sceneGraphSelection);
              ...
              case 5:
                _context2.next = 7;
                return getContentTypeData(id, selectedNodes.length).then(
                /*#__PURE__*/
                function () {
                  var _ref2 = asyncToGenerator(
                  /*#__PURE__*/
                  regenerator.mark(function _callee(items) {
                    var filteredItems;
                    return regenerator.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.t0 = id;
                            _context.next = _context.t0 === "#names" ? 3 : _context.t0 === "#email" ? 5 : _context.t0 === "#countries" ? 7 : _context.t0 === "#usernames" ? 9 : _context.t0 === "#addresses" ? 11 : 13;
                            break;

                          case 3:
                            filteredItems = items.map(function (item) {
                              return dist_2("".concat(item.name.first, " ").concat(item.name.last), "capitalize");
                            });
                          ...
                          case 7:
                            filteredItems = items.map(function (item) {
                              return "".concat(dist_2(item.location.city, "capitalize"));
                            });
                            return _context.abrupt("break", 14);
                          ...
                          case 11:
                            filteredItems = items.map(function (item) {
                              return "".concat(item.location.street, ", ").concat(item.location.city, ", ").concat(item.location.state, ", ").concat(item.location.postcode, " ");
                            });
                            return _context.abrupt("break", 14);
                          ...
                          case 14:
                            _context.next = 16;
                            return _this.setLayersText(selectedNodes, filteredItems);
    ...
    defineProperty(this, "setLayersText", function (selectedNodes, filteredItems) {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = selectedNodes.entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _step$value = slicedToArray(_step.value, 2),
              index = _step$value[0],
              nodeId = _step$value[1];

          var node = window.figmaPlus.scene.getNodeById(nodeId);
